    ...
    <body>
        ...
        <script>
            ...
            function passValues() {
                ...
                xhr.send(memdet1 + memdet2 + memdet3 + memdet4 + memdet5);
                xhr.onload = function() {
                    if (xhr.status !== 200) {
                        alert("Error: Connection Failed.");
                    } else {
                        document.getElementById('memForms').style.display = "none";
                        document.getElementById('editInfo').style.display = "block";
                        document.querySelector('.member-box').style.display = "flex";
                        const container = document.querySelector('.member-box');
